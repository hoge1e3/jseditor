  ...
  return Tonyu.klass.define({
    ...
    methods: {
      ...
      create :function _trc_FileMenu_create() {
        ...
        //$LASTPOS=6000047;//jseditor.FileMenu:47
        dir = _this.curDir;
        
        //$LASTPOS=6000067;//jseditor.FileMenu:67
        if (! dir) {
          return _this;
        }
        //$LASTPOS=6000089;//jseditor.FileMenu:89
        n = _this.prompt("ファイル名");
        
        //$LASTPOS=6000116;//jseditor.FileMenu:116
        if (! n) {
          return _this;
        }
        //$LASTPOS=6000136;//jseditor.FileMenu:136
        nf = dir.rel(n);
        
        //$LASTPOS=6000159;//jseditor.FileMenu:159
        isd = _this.isDir(nf);
        
        //$LASTPOS=6000182;//jseditor.FileMenu:182
        if (isd) {
          //$LASTPOS=6000201;//jseditor.FileMenu:201
          _this.mkdir(nf);
          
        } else {
          //$LASTPOS=6000233;//jseditor.FileMenu:233
          _this.writeFile(nf,"");
          
        }
        //$LASTPOS=6000261;//jseditor.FileMenu:261
      ...
      cdfl :function _trc_FileMenu_cdfl() {
        ...
        //$LASTPOS=6000306;//jseditor.FileMenu:306
        if (_this.curDir) {
          //$LASTPOS=6000318;//jseditor.FileMenu:318
      ...
      rename :function _trc_FileMenu_rename() {
        ...
        //$LASTPOS=6000348;//jseditor.FileMenu:348
        _this.cdfl();
        //$LASTPOS=6000360;//jseditor.FileMenu:360
        _this.print(_this.cwd.path());
        //$LASTPOS=6000383;//jseditor.FileMenu:383
        f = _this.fileList.lastSelected;
        
        //$LASTPOS=6000416;//jseditor.FileMenu:416
        if (! f) {
          return _this;
        }
        //$LASTPOS=6000436;//jseditor.FileMenu:436
        nf = _this.prompt("ファイル名の変更",f.name());
        
        //$LASTPOS=6000476;//jseditor.FileMenu:476
        if (! nf) {
          return _this;
        }
        //$LASTPOS=6000497;//jseditor.FileMenu:497
        nf=_this.resolve(nf);
        //$LASTPOS=6000517;//jseditor.FileMenu:517
        _this.mv(f,nf);
        //$LASTPOS=6000531;//jseditor.FileMenu:531
        _this.editorSet.close(f);
        //$LASTPOS=6000555;//jseditor.FileMenu:555
        _this.waitFor(_this.fileList.open(nf));
        //$LASTPOS=6000587;//jseditor.FileMenu:587
        if (_this.curDir) {
          //$LASTPOS=6000599;//jseditor.FileMenu:599
      ...
      remove :function _trc_FileMenu_remove() {
        ...
        //$LASTPOS=6000706;//jseditor.FileMenu:706
        fl = _this.fileList;
        
        //$LASTPOS=6000727;//jseditor.FileMenu:727
        f = fl.lastSelected;
        
        //$LASTPOS=6000754;//jseditor.FileMenu:754
        if (! f) {
          return _this;
        }
        //$LASTPOS=6000774;//jseditor.FileMenu:774
        r = _this.confirm(f.path()+"を削除しますか？");
        
        //$LASTPOS=6000814;//jseditor.FileMenu:814
        if (! r) {
          return _this;
        }
        //$LASTPOS=6000834;//jseditor.FileMenu:834
        _this.rm(f);
        //$LASTPOS=6000845;//jseditor.FileMenu:845
        _this.editorSet.close(f);
        //$LASTPOS=6000869;//jseditor.FileMenu:869
        if (_this.curDir) {
          //$LASTPOS=6000881;//jseditor.FileMenu:881
