  ...
  return Tonyu.klass.define({
    ...
    methods: {
      ...
      initialize :function _trc_Bookmark_initialize(p) {
        ...
        //$LASTPOS=5000045;//jseditor.Bookmark:45
        Tonyu.classes.jseditor.Base.apply( _this, [p]);
        //$LASTPOS=5000059;//jseditor.Bookmark:59
      ...
      open :function _trc_Bookmark_open() {
        ...
        function refresh() {
          ...
          //$LASTPOS=5000452;//jseditor.Bookmark:452
          items.empty();
          //$LASTPOS=5000475;//jseditor.Bookmark:475
          _this.conf.data.forEach((function anonymous_493(d) {
            var item;
            
            //$LASTPOS=5000512;//jseditor.Bookmark:512
            item = UI("div",["a",{href: d.url},d.title]);
            
            //$LASTPOS=5000604;//jseditor.Bookmark:604
            items.append(item);
          }));
        }function ok() {
          
          //$LASTPOS=5000661;//jseditor.Bookmark:661
          d.dialog("close");
        }function edit() {
          
          //$LASTPOS=5000708;//jseditor.Bookmark:708
          _this.fileList.open(_this.file);
        }function add() {
          var urlHead;
          
          //$LASTPOS=5000756;//jseditor.Bookmark:756
          urlHead = location.href.replace(/\?.*/,"").replace(/#/,"");
          
          //$LASTPOS=5000826;//jseditor.Bookmark:826
          _this.conf.data.push({title: _this.fileList.curDir.name(),url: urlHead+"?dir="+_this.fileList.curDir.path()});
          //$LASTPOS=5000959;//jseditor.Bookmark:959
          _this.conf.save();
          //$LASTPOS=5000980;//jseditor.Bookmark:980
          refresh();
        }
        //$LASTPOS=5000100;//jseditor.Bookmark:100
        _this.conf.load();
        //$LASTPOS=5000117;//jseditor.Bookmark:117
        items = UI("div");
        
        //$LASTPOS=5000142;//jseditor.Bookmark:142
        ...
        //$LASTPOS=5000389;//jseditor.Bookmark:389
        d.dialog({width: 600});
        //$LASTPOS=5000416;//jseditor.Bookmark:416
        refresh();
