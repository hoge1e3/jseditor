  ...
  return Tonyu.klass.define({
    ...
    methods: {
      main :function _trc_MyForm_main() {
        ...
        //$LASTPOS=22000017;//jseditor.MyForm:17
        _this.tag("div",(function anonymous_28() {
          
          //$LASTPOS=22000035;//jseditor.MyForm:35
          _this.tag("h1",_this.mesg||"てすと！");
          //$LASTPOS=22000063;//jseditor.MyForm:63
          _this.num=_this.tag("span",0);
          //$LASTPOS=22000087;//jseditor.MyForm:87
          _this.tag("br");
          //$LASTPOS=22000102;//jseditor.MyForm:102
          _this.tag("button",{on: {click: Tonyu.bindFunc(_this,_this.inc)}},"+");
          //$LASTPOS=22000142;//jseditor.MyForm:142
          _this.tag("button",{on: {click: Tonyu.bindFunc(_this,_this.countP)}},"+10");
        }));
        //$LASTPOS=22000186;//jseditor.MyForm:186
        _this.i=0;
      },
      ...
      countP :function _trc_MyForm_countP() {
        ...
        //$LASTPOS=22000203;//jseditor.MyForm:203
      ...
      count :function _trc_MyForm_count() {
        ...
        //$LASTPOS=22000239;//jseditor.MyForm:239
        //$LASTPOS=22000244;//jseditor.MyForm:244
        i = 0;
        for (; i<10 ; i++) {
          {
            //$LASTPOS=22000273;//jseditor.MyForm:273
            _this.inc();
            //$LASTPOS=22000288;//jseditor.MyForm:288
            _this.update(50);
          }
        }
      },
      ...
      inc :function _trc_MyForm_inc() {
        ...
        //$LASTPOS=22000321;//jseditor.MyForm:321
        _this.i++;
        //$LASTPOS=22000330;//jseditor.MyForm:330
      ...
      test :function _trc_MyForm_test() {
        ...
        //$LASTPOS=22000359;//jseditor.MyForm:359
